...
<head>
    ...
    <STYLE type="text/css">
        ...
        #ar{background: linear-gradient(to right bottom,lightblue,lightgrey);
...
<table border="1px" style="text-align: center;margin:50px;margin-left:280px;position: center;" >
    <caption style="text-align: center">购物车</caption>
    ...
    <div class="row-fluid" style="float: left;" >
            <tr>
                ...
                <td colspan="4" style="width: 80px;">
                    <form action="delcar?id=${requestScope.id}" method="post"><br>
                    ...
                    <button type="submits" class="btn btn-danger">移除</button>
                    </form>
                </td>
            </tr>
        </div>
...
<form action="pay?id=${requestScope.id}" method="post">
    <div style="border: green 1px solid;border-radius: 10px;width: 180px;background-color:#bce8f1;margin-top:-10px;margin-left: 650px; text-align: center">
        <text style="color: red;font-size: large;font-style: unset;">￥&nbsp;${requestScope.all}</text>
    </div>
    <button type="submit" class="btn btn-success" STYLE="margin-left: 0px; margin-left: 665px;width: 150px;border-radius: 10px;" >银行卡支付</button>
</form>
</body>
</html>
